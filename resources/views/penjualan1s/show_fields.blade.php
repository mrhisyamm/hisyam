...
<div class="row">
    ...
    <div class="col-md-3 col-sm-3">
        <h4>Tanggal</h4>
        <p><?php echo date('d F Y', strtotime($penjualan1->tanggal)); ?></p>
    </div>
...
<div class="row">
    ...
    <table class="table table-bordered">
        ...
        @foreach ($penjualan1->detailPenjualan1s as $row=>$item)
            <tr>
                <td>{{$row + 1 }}</td>
        ...
        <tr>
            ...
            <td class="text-left"><h4>Rp. {{number_format($penjualan1->total, 2,",",".")}}</h4></td>
        </tr>
